...
namespace Microsoft.VisualStudio.Project.Samples.NestedProject.UnitTests
{
	...
	internal class VisualStudio_Project_Samples_GeneralPropertyPageAccessor : BaseAccessor
	{
		...
		internal PlatformType targetPlatform
		{
			get
			{
				PlatformType ret = ((PlatformType)(m_privateObject.GetField("targetPlatform")));
				return ret;
			}
			set
			{
				m_privateObject.SetField("targetPlatform", value);
			}
		}

		internal string targetPlatformLocation
		{
			get
			{
				string ret = ((string)(m_privateObject.GetField("targetPlatformLocation")));
				return ret;
			}
			set
			{
				m_privateObject.SetField("targetPlatformLocation", value);
			}
		}
