<%@ Page language="c#" Inherits="NUnitAspTestPages.AspTester.DropDownListTestPage" Codebehind="DropDownListTestPage.aspx.cs" %>
...
<HTML>
	...
	<body>
		<form method="post" runat="server">
			<p>
				Test List:
				<asp:DropDownList id="list" runat="server" onselectedindexchanged="index_Changed"></asp:DropDownList>
