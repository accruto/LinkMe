<%@ Page language="c#" Inherits="NUnitAspTestPages.HttpBrowserTestPage" Codebehind="HttpClientTestPage.aspx.cs" %>
...
<HTML>
	...
	<body>
		<form method="post" runat="server" id="HttpBrowserTestPage">
