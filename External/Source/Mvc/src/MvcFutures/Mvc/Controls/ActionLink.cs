namespace Microsoft.Web.Mvc.Controls {
    ...
    public class ActionLink : MvcControl {
        ...
        public string ActionName {
            get {
                return _actionName ?? String.Empty;
            }
            set {
                _actionName = value;
            }
        ...
        public string ControllerName {
            get {
                return _controllerName ?? String.Empty;
            }
            set {
        ...
        public string RouteName {
            get {
                return _routeName ?? String.Empty;
            }
            set {
                _routeName = value;
            }
        ...
        protected override void Render(HtmlTextWriter writer) {
            ...
            if (DesignMode) {
                ...
                VirtualPathData vpd = RouteTable.Routes.GetVirtualPath(ViewContext.RequestContext, RouteName, routeValues);
                if (vpd == null) {
