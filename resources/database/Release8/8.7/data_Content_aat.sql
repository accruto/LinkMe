...
SET @title = 'Association of Accounting Technicians Australia'
...
VALUES
	(@id, 'String', 'Text', '<div>      <a href="http://www.aat.org.au"><img alt="Association of Accounting Technicians Australia" src="~/themes/communities/aat/img/banner.jpg" style="border-style:none;" /></a>  </div>')
...
INSERT
	n2Detail (ItemID, Type, Name, StringValue)
VALUES
	(@id, 'String', 'RootFolder', '~/themes/communities/aat/img/')
