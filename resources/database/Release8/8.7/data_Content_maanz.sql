...
SET @title = 'Marketing Association of Australia and New Zealand'
...
VALUES
	(@id, 'String', 'Text', '<div>      <a href="http://www.marketing.org.au"><img alt="Marketing Association of Australia and New Zealand" src="~/themes/communities/maanz/img/banner.jpg" style="border-style:none;" /></a>  </div>')
...
INSERT
	n2Detail (ItemID, Type, Name, StringValue)
VALUES
	(@id, 'String', 'RootFolder', '~/themes/communities/maanz/img/')
