...
VALUES
	(@id, 'String', 'Text', '<div>      <a href="http://www.centenary.scouts.com.au/main.asp?sKeyword=HOME"><img alt="Scouts Australia" src="~/themes/communities/scouts/img/banner.jpg" style="border-style:none;" /></a>  </div>')
...
INSERT
	n2Detail (ItemID, Type, Name, StringValue)
VALUES
	(@id, 'String', 'RootFolder', '~/themes/communities/scouts/img/')
