...
SET @title = 'Australian Institute of Marine and Power Engineers'
...
VALUES
	(@id, 'String', 'Text', '<div>      <a href="http://www.aimpe.asn.au"><img alt="Australian Institute of Marine and Power Engineers" src="~/themes/communities/aimpe/img/banner.jpg" style="border-style:none;" /></a>  </div>')
...
INSERT
	n2Detail (ItemID, Type, Name, StringValue)
VALUES
	(@id, 'String', 'RootFolder', '~/themes/communities/aimpe/img/')
