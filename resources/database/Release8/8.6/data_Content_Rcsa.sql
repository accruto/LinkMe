...
SET @title = 'RCSA Australia & New Zealand'
...
VALUES
	(@id, 'String', 'Text', '<div>      <a href="http://www.rcsa.com.au"><img alt="RCSA" src="~/themes/communities/rcsa/img/banner.gif" style="border-style:none" /></a>  </div>')
...
INSERT
	n2Detail (ItemID, Type, Name, StringValue)
VALUES
	(@id, 'String', 'RootFolder', '~/themes/communities/rcsa/img/')
