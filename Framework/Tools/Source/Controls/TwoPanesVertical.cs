...
namespace LinkMe.Framework.Tools.Controls
{
	...
	/// </summary>
	[ToolboxBitmap(typeof(LinkMe.Framework.Tools.Bitmaps.Location), "TwoPanesVertical.bmp")]
	public class TwoPanesVertical : UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			// PaneOne
			// 
			this.PaneOne.Dock = System.Windows.Forms.DockStyle.Left;
			this.PaneOne.Location = new System.Drawing.Point(0, 0);
			this.PaneOne.Name = "PaneOne";
			this.PaneOne.Size = new System.Drawing.Size(360, 352);
			this.PaneOne.TabIndex = 5;
			// 
			// PaneTwo
			// 
			this.PaneTwo.Dock = System.Windows.Forms.DockStyle.Fill;
			this.PaneTwo.Location = new System.Drawing.Point(366, 0);
			this.PaneTwo.Name = "PaneTwo";
			this.PaneTwo.Size = new System.Drawing.Size(360, 352);
			this.PaneTwo.TabIndex = 6;
			// 
			// TwoPanesVertical
			// 
		...
		/// <summary>
		/// True to show the first (left) pane, false to hide it. The default is true.
		/// </summary>
		...
		/// <summary>
		/// True to show the second (right) pane, false to hide it. The default is true.
		/// </summary>
		...
		/// <summary>
		/// The minimum size of the first (left) pane. The default is 30.
		/// </summary>
		...
		/// <summary>
		/// The minimum size of the second (right) pane. The default is 30.
		/// </summary>
