...
namespace LinkMe.Framework.VisualStudio.Package
{
	...
	public enum BuildAction { None, Catalogue }
		...
		: EnumConverter
	{
		...
		public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
		{
			...
			if ( str != null )
			{
				if ( str == StringResourceManager.GetString(typeof(Resources.StringResources), Constants.BuildAction.Catalogue, culture) )
					return BuildAction.Catalogue;
		...
		{
			return new StandardValuesCollection(new BuildAction[] { BuildAction.Catalogue, BuildAction.None });
		}
	}
}
