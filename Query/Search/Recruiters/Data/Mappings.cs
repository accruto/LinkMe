...
namespace LinkMe.Query.Search.Recruiters.Data
{
    ...
    internal static class Mappings
    {
        public static Organisation Map(this OrganisationEntity entity, string parentFullName, ILocationQuery locationQuery)
        {
            ...
            {
                var organisation = new Organisation { Id = entity.id };
                entity.MapTo(organisation, locationQuery);
                return organisation;
            }

            var verifiedOrganisation = new VerifiedOrganisation { Id = entity.id };
        ...
        public static ContactDetails Map(this ContactDetailsEntity entity)
        {
            return entity.Map();
        }
