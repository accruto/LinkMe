...
#pragma warning restore 168
    ...
    //  Assert.AreEqual( 1, synMap.submap.size() );
    //  Assert.AreEqual( 1, getSubSynonymMap( synMap, "ab" ).submap.size() );
    //  Assert.AreEqual( 1, getSubSynonymMap( getSubSynonymMap( synMap, "ab" ), "bc" ).submap.size() );
    ...
    private void assertTokIncludes( SynonymMap map, string src, string exp ) {
