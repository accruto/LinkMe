...
namespace org.apache.solr.spelling
{
  ...
  using WhitespaceAnalyzer = org.apache.lucene.analysis.WhitespaceAnalyzer;
  //using org.apache.lucene.util.LuceneTestCase;
  //using org.apache.solr.common.util.NamedList;
  ...
  //    assertTrue("Token offsets do not match", isOffsetCorrect(original, tokens));
    ...
    private static bool isOffsetCorrect(string s, Collection/*<Token>*/ tokens) {
    ...
    public void testBoolean()
    {
      ...
      var original = "developer OR programmer";
      Collection/*<Token>*/ tokens = converter.convert(original);
      ...
      original = "(developer OR programmer) AND cobol";
      tokens = converter.convert(original);
      Assert.IsNotNull(tokens);
    ...
    private static void assertTrue(string message, bool expected)
    {
