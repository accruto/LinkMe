namespace org.apache.solr.spelling
{
  ...
  public class RankedSpellPossibility : java.lang.Comparable/*<RankedSpellPossibility>*/ {
	  private List/*<SpellCheckCorrection>*/ corrections;
	  private int rank;

	  public int CompareTo(object rcl) {
		  return rank.CompareTo(((RankedSpellPossibility)rcl).rank);
	  }
