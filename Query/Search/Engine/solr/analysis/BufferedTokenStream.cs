...
namespace org.apache.solr.analysis
{
  ...
  using TokenFilter = lucene.analysis.TokenFilter;
   ...
   * @version $Id$
   */
  public abstract class BufferedTokenStream : TokenFilter {
    // in the future, might be faster if we implemented as an array based CircularQueue
    private readonly LinkedList/*<Token>*/ inQueue = new LinkedList/*<Token>*/();
    private readonly LinkedList/*<Token>*/ outQueue = new LinkedList/*<Token>*/();

    protected BufferedTokenStream(TokenStream input) : base(input) {
    }
    ...
    public override Token next()  {
      while (true) {
        if (!outQueue.isEmpty()) return (Token) outQueue.removeFirst();
        Token t = read();
        if (null == t) return null;
        Token output = process(t);
...
#pragma warning restore 612
      ...
      return (Token) inQueue.removeFirst();
    }
...
#pragma warning restore 612
     ...
     */
    protected java.lang.Iterable/*<Token>*/ output() {
      return outQueue;
    }
