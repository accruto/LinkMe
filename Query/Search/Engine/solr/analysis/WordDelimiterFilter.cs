...
namespace org.apache.solr.analysis
{
   ...
   *
   *  @version $Id: WordDelimiterFilter.java 808005 2009-08-26 13:32:46Z yonik $
   */

  public sealed class WordDelimiterFilter : TokenFilter {
    private readonly byte[] charTypeTable;

    public static readonly byte         LOWER=0x01;
    public static readonly byte         UPPER=0x02;
    public static readonly byte         DIGIT=0x04;
    public static readonly byte SUBWORD_DELIM=0x08;

    // combinations: for testing, not for setting bits
    public static readonly int    ALPHA=0x03;
    public static readonly int    ALPHANUM=0x07;
     ...
     * "PowerShot" => "Power" "Shot"
     */
    readonly int generateWordParts;
     ...
     * "500-42" => "500" "42"
     */
    readonly int generateNumberParts;
     ...
     * "O'Neil's" => "O", "Neil"
     */
    readonly int stemEnglishPossessive;
    
    /**
     * If not null is the set of tokens to protect from being delimited
     *
     */
    readonly CharArraySet protWords;
     ...
     */
    [Obsolete]
    public WordDelimiterFilter(TokenStream input, byte[] charTypeTable, int generateWordParts, int generateNumberParts, int catenateWords, int catenateNumbers, int catenateAll, int splitOnCaseChange, int preserveOriginal,int splitOnNumerics, CharArraySet protWords) :
      this(input,charTypeTable,generateWordParts,generateNumberParts,catenateWords,catenateNumbers,catenateAll,splitOnCaseChange,preserveOriginal, 1, 1, null)
    {}
