...
{
    [TestClass]
    public class SubmitWithResumeTests
        : SubmitTests
    {
        [TestMethod]
        public void TestSubmitProfileFile()
        {
            ...
            var applicationId = _internalApplicationsCommand.SubmitApplicationWithResume(member, jobAd, fileReference.Id, false, null);
        ...
        public void TestSubmitProfileFileUseForProfile()
        {
            ...
            var employer = CreateEmployer();
            var jobAd = CreateJobAd(employer);
            var applicationId = _internalApplicationsCommand.SubmitApplicationWithResume(member, jobAd, fileReference.Id, true, null);
        ...
        public void TestMultipleFiles()
        {
            ...
            var employer = CreateEmployer();
            var jobAd = CreateJobAd(employer);
            var applicationId = _internalApplicationsCommand.SubmitApplicationWithResume(member, jobAd, fileReference2.Id, false, null);
        ...
        public void TestMultipleFilesUseForProfile()
        {
            ...
            var employer = CreateEmployer();
            var jobAd = CreateJobAd(employer);
            var applicationId = _internalApplicationsCommand.SubmitApplicationWithResume(member, jobAd, fileReference2.Id, true, null);
        ...
        public void TestUnknownFile()
        {
            ...
            var employer = CreateEmployer();
            var jobAd = CreateJobAd(employer);
            _internalApplicationsCommand.SubmitApplicationWithResume(member, jobAd, Guid.NewGuid(), false, null);
        }
