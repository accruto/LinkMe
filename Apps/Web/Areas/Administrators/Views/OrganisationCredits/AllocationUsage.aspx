<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/MasterPages/Block.Page.master" Inherits="LinkMe.Apps.Asp.Mvc.Views.ViewPage<OrganisationAllocationExercisedCreditsModel>" %>
    ...
    <div class="section">
	    <div class="section-body">
		    <ul class="plain-actions actions">
                ...
                <li><%= Html.RouteRefLink("View credit usage", OrganisationsRoutes.Usage, new { id = Model.Organisation.Id })%></li>
		    </ul>
	    </div>
    </div>
</asp:Content>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="page-title">
        <h1>Organisation allocation usage</h1>
    </div>
