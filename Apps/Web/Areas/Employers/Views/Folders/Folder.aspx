    ...
    <script language="javascript" type="text/javascript">
        ...
        function updateResults(isCreditAction) {
            (function($) {
                ...
                currentRequest = $.get("<%= Html.RouteRefUrl(CandidatesRoutes.PartialFolder, new { folderId = Model.Folder.Id }) %>",
                    requestData,
                    function(data, textStatus, xmlHttpRequest) {
                        ...
                        hideResultsOverlay();
                        $("#folder-header-text").html($("#results-header-text").html());
...
<asp:Content ContentPlaceHolderID="BreadCrumbs" runat="server">
    <ul class="breadcrumbs">
        ...
        <li class="current-breadcrumb"><%= Model.Folder.GetNameDisplayText() %></li>
    </ul>
</asp:Content>
    ...
    <script type="text/javascript">
        (function($) {
            ...
            $(".js_rename-folder").click(function() {
                $("#rename-folder-header").css("display", "block");
                $("#folder-header").css("display", "none");
            });
            $(".js_delete-folder").click(function() {
                showDeleteFolderOverlay(
                    "<%= Model.Folder.Id %>",
                    <%= Model.Folder.FolderType == FolderType.Private ? "true" : "false" %>,
                    function() {
                        window.location.replace(foldersUrl);
                    });
            });
