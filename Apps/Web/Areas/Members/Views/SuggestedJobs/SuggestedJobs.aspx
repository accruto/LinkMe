<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/MasterPages/Page.Master" Inherits="LinkMe.Apps.Asp.Mvc.Views.ViewPage<SuggestedJobsListModel>" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="rightside <%= CurrentMember == null ? "notloggedin" : "" %>  <%= Model.ListType %>" partialurl="<%= Html.MungeUrl(Html.RouteRefUrl(JobAdsRoutes.SuggestedPartial)) %>">
