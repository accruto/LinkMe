...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="rightside <%= Model.ListType %>" partialurl="<%= Html.MungeUrl(Html.RouteRefUrl(JobAdsRoutes.PartialFlagList)) %>">
        <div class="resultheader">
            <div class="icon"></div>
            <div class="title">Flagged jobs</div>
        </div>
