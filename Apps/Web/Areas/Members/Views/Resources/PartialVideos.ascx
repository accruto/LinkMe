...
<%  if (Model.Results.ResourceIds.Count == 0)
    { %>
        <div class="empty">
            ...
            <div class="bg">
                <div class="text">There are no videos in this category</div>
            </div>
...
<%  }
    else
    {
        ...
        Html.RenderPartial("Pagination", Tuple.Create((ResourceListModel)Model, Model.TotalResources[ResourceType.Video]));
    } %>
</div>
