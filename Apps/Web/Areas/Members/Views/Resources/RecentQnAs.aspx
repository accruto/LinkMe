<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/MasterPages/Page.Master" Inherits="LinkMe.Apps.Asp.Mvc.Views.ViewPage<ResourceListModel<LinkMe.Domain.Resources.QnA>>" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="maincontent">
        ...
        <div class="tabcontent">
            ...
            <div class="bg">
                <% Html.RenderPartial("PartialRecentQnAs", Model); %>
            </div>
