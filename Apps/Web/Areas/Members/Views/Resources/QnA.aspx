<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/MasterPages/Page.Master" Inherits="LinkMe.Apps.Asp.Mvc.Views.ViewPage<ResourceModel<LinkMe.Domain.Resources.QnA>>" %>
...
<asp:Content ContentPlaceHolderID="PageTitle" runat="server">
    <% Page.Title = "Question: " + Model.Resource.Title; %>
</asp:Content>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="maincontent">
        ...
        <div class="tabcontent">
            ...
            <div class="bg">
                <% Html.RenderPartial("PartialQnA", Model); %>
            </div>
