...
/* Which one is taller, <body> or <html>? */
		if (ender('body').offset().height > ender('html').offset().height) {
			...
			var largerHeight = ender('body')[0].scrollHeight;
		}
		else {
			//var largerHeight = ender('html').offset().height;
			var largerHeight = ender('html')[0].scrollHeight;
		}
...
/*  Create CSS */
    var styles = '\
        ...
        .ggs-switchBar {background: '+switchColor+'; height: 4px; margin-bottom: 4px; float:none; }\
        ...
        .ggs-line {border-top: 1px dotted '+guideColor+'; height: '+baselineGridHeight+'; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; -o-box-sizing: border-box; box-sizing: border-box; float : none; }\
...
/* 	Add listeners for switch element */
	...
	//default ggs switch on
	//ender("#ggs-switch").click();
});