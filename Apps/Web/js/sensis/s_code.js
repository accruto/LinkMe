...
/* Specify the Report Suite ID(s) to track here - NB - THIS MUST BE CHANGED FROM "dev" to "prd" FOR THE PRODUCTION ENVIRONMENT */

var s_account="telstraglobalprd,telstrasslinkmeprd"
var s=s_gi(s_account)
/************************** CONFIG SECTION **************************/
s.trackDownloadLinks=true
s.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,doc,pdf,xls"
s.trackExternalLinks=true
s.linkInternalFilters="javascript:,competition.whereis.com"
...
s.eventList="event2,event3,event4"
/* End Form Analysis */
...
function s_doPlugins(s) {
	...
	/* Populate the Sensis Internal campaign code */
  	s.eVar9=s.getQueryParam('intref')
  
	/* Populate the Sensis External campaign code */
	s.eVar10=s.getQueryParam('referrer')

	/* Populate the intra site campaign codes (and traffic for network navigation) */
	s.eVar13=s.getQueryParam('ref')
	s.prop13=s.getQueryParam('ref')

	s.prop12=s.getQueryParam('keywords')
	s.eVar22=s.getQueryParam('keywords')

	s.prop25=s.getQueryParam('locality')
	s.eVar35=s.getQueryParam('locality')

	/* Call the Form Analysis Plugin */
	s.setupFormAnalysis()
