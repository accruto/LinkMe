<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SharedEmployerHeader.ascx.cs" Inherits="LinkMe.Web.UI.Controls.Common.Navs.Verticals.SharedEmployerHeader" %>
...
<div id="header-links-container">
    ...
    <%  if (CanPurchase())
        { %>
		            <div class="header-link"><a href="<%=NewOrderUrl%>"><span class="menu-text">Purchase</span></a></div>
    <%  } %>
