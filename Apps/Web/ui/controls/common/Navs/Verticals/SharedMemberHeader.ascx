<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SharedMemberHeader.ascx.cs" Inherits="LinkMe.Web.UI.Controls.Common.Navs.Verticals.SharedMemberHeader" %>
...
<%  }
    ...
    { %>
                    <div class="header-link">
                        <a href="<%= AnonymousProfileUrl %>"><span class="menu-text"><span class="arrow">Profile</span></span></a>
                    </div>
<%  }
...
<%  }
    ...
    { %>
		            <div class="header-link">
			            <a href="<%= AnonymousFriendsUrl %>"><span class="menu-text"><span class="arrow">Friends</span></span></a>
		            </div>
<%  } %>
