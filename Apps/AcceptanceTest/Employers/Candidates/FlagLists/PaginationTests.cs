...
namespace LinkMe.AcceptanceTest.Employers.Candidates.FlagLists
{
        ...
        : FlagListsTests
    {
        ...
        public void Test1Candidate()
        {
            ...
            CreateCandidates(1, employer, flagList);

            // Access the page.

            LogIn(employer);

            TestPagination(null, null, 1, 1, 1, 1, 1, 1);
            TestPagination(1, 10, 1, 1, 1, 1, 1, 1);
            TestPagination(1, 25, 1, 1, 1, 1, 1, 1);
            TestPagination(1, 50, 1, 1, 1, 1, 1, 1);
            TestPagination(1, 100, 1, 1, 1, 1, 1, 1);
        }
        ...
        public void Test5Candidates()
        {
            var employer = CreateEmployer();
            var flagList = _candidateFlagListsQuery.GetFlagList(employer);
            CreateCandidates(5, employer, flagList);

            // Access the page.

            LogIn(employer);

            TestPagination(null, null, 1, 5, 5, 1, 1, 1);
            TestPagination(1, 10, 1, 5, 5, 1, 1, 1);
            TestPagination(1, 25, 1, 5, 5, 1, 1, 1);
            TestPagination(1, 50, 1, 5, 5, 1, 1, 1);
            TestPagination(1, 100, 1, 5, 5, 1, 1, 1);
        }
        ...
        public void Test20Candidates()
        {
            var employer = CreateEmployer();
            var flagList = _candidateFlagListsQuery.GetFlagList(employer);
            CreateCandidates(20, employer, flagList);

            // Access the page.

            LogIn(employer);

            TestPagination(null, null, 1, 20, 20, 1, 1, 1);

            TestPagination(1, 10, 1, 10, 20, 2, 1, 2);
            TestPagination(2, 10, 11, 20, 20, 2, 1, 2);

            TestPagination(1, 25, 1, 20, 20, 1, 1, 1);
            TestPagination(1, 50, 1, 20, 20, 1, 1, 1);
            TestPagination(1, 100, 1, 20, 20, 1, 1, 1);
        }
        ...
        public void Test40Candidates()
        {
            var employer = CreateEmployer();
            var flagList = _candidateFlagListsQuery.GetFlagList(employer);
            CreateCandidates(40, employer, flagList);

            // Access the page.

            LogIn(employer);

            TestPagination(null, null, 1, 25, 40, 2, 1, 2);

            TestPagination(1, 10, 1, 10, 40, 4, 1, 4);
            TestPagination(2, 10, 11, 20, 40, 4, 1, 4);
            TestPagination(3, 10, 21, 30, 40, 4, 1, 4);
            TestPagination(4, 10, 31, 40, 40, 4, 1, 4);

            TestPagination(1, 25, 1, 25, 40, 2, 1, 2);
            TestPagination(2, 25, 26, 40, 40, 2, 1, 2);

            TestPagination(1, 50, 1, 40, 40, 1, 1, 1);
            TestPagination(1, 100, 1, 40, 40, 1, 1, 1);
        }
        ...
        public void Test60Candidates()
        {
            var employer = CreateEmployer();
            var flagList = _candidateFlagListsQuery.GetFlagList(employer);
            CreateCandidates(60, employer, flagList);

            // Access the page.

            LogIn(employer);

            TestPagination(null, null, 1, 25, 60, 3, 1, 3);

            TestPagination(1, 10, 1, 10, 60, 6, 1, 6);
            TestPagination(2, 10, 11, 20, 60, 6, 1, 6);
            TestPagination(3, 10, 21, 30, 60, 6, 1, 6);
            TestPagination(4, 10, 31, 40, 60, 6, 1, 6);
            TestPagination(5, 10, 41, 50, 60, 6, 1, 6);
            TestPagination(6, 10, 51, 60, 60, 6, 1, 6);

            TestPagination(1, 25, 1, 25, 60, 3, 1, 3);
            TestPagination(2, 25, 26, 50, 60, 3, 1, 3);
            TestPagination(3, 25, 51, 60, 60, 3, 1, 3);

            TestPagination(1, 50, 1, 50, 60, 2, 1, 2);
            TestPagination(2, 50, 51, 60, 60, 2, 1, 2);

            TestPagination(1, 100, 1, 60, 60, 1, 1, 1);
        }
        ...
        public void Test150Candidates()
        {
            var employer = CreateEmployer();
            var flagList = _candidateFlagListsQuery.GetFlagList(employer);
            CreateCandidates(150, employer, flagList);

            // Access the page.

            LogIn(employer);

            TestPagination(null, null, 1, 25, 150, 6, 1, 6);

            TestPagination(1, 10, 1, 10, 150, 15, 1, 11);
            TestPagination(2, 10, 11, 20, 150, 15, 1, 11);
            TestPagination(3, 10, 21, 30, 150, 15, 1, 11);
            TestPagination(4, 10, 31, 40, 150, 15, 1, 11);
            TestPagination(5, 10, 41, 50, 150, 15, 1, 11);
            TestPagination(6, 10, 51, 60, 150, 15, 1, 11);
            TestPagination(7, 10, 61, 70, 150, 15, 2, 12);
            TestPagination(8, 10, 71, 80, 150, 15, 3, 13);
            TestPagination(9, 10, 81, 90, 150, 15, 4, 14);
            TestPagination(10, 10, 91, 100, 150, 15, 5, 15);
            TestPagination(11, 10, 101, 110, 150, 15, 5, 15);
            TestPagination(12, 10, 111, 120, 150, 15, 5, 15);
            TestPagination(13, 10, 121, 130, 150, 15, 5, 15);
            TestPagination(14, 10, 131, 140, 150, 15, 5, 15);
            TestPagination(15, 10, 141, 150, 150, 15, 5, 15);

            TestPagination(1, 25, 1, 25, 150, 6, 1, 6);
            TestPagination(2, 25, 26, 50, 150, 6, 1, 6);
            TestPagination(3, 25, 51, 75, 150, 6, 1, 6);
            TestPagination(4, 25, 76, 100, 150, 6, 1, 6);
            TestPagination(5, 25, 101, 125, 150, 6, 1, 6);
            TestPagination(6, 25, 126, 150, 150, 6, 1, 6);

            TestPagination(1, 50, 1, 50, 150, 3, 1, 3);
            TestPagination(2, 50, 51, 100, 150, 3, 1, 3);
            TestPagination(3, 50, 101, 150, 150, 3, 1, 3);

            TestPagination(1, 100, 1, 100, 150, 2, 1, 2);
            TestPagination(2, 100, 101, 150, 150, 2, 1, 2);
        }

        private void TestPagination(int? page, int? items, int start, int end, int total, int totalPages, int firstPage, int lastPage)
        {
            Get(GetFlagListUrl(page, items));
