...
namespace LinkMe.AcceptanceTest.Administrators.Communications.Campaigns.IosLaunch
{
        ...
        : IosLaunchCampaignsTests
    {
        ...
        public void UpdateTest()
        {
            ...
            var definitionId = _settingsQuery.GetDefinition("IosLaunchEmail").Id;
            var categoryId = _settingsQuery.GetCategory("Campaign").Id;
            AssertCampaign(CampaignCategory.Employer, definitionId, categoryId, null, _campaignsQuery.GetCampaign(campaign.Id));
            ...
            AssertCampaign(CampaignCategory.Employer, definitionId, categoryId, null, _campaignsQuery.GetCampaign(campaign.Id));
            AssertCampaign(CampaignCategory.Employer, definitionId, categoryId, null, _campaignsQuery.GetCampaign(UpdatedCampaignName));
        }
