...
namespace LinkMe.AcceptanceTest.Members.Jobs.Applications.ManagedExternally
{
        ...
        : ManagedExternallyTests
    {
        ...
        public void TestSubmitProfileFileUseForProfile()
        {
            ...
            LogIn(member);
            AssertStatus(jobAd, member.Id, false, true, fileReference.FileName);
            var applicationId = AssertApply(ApiApplyWithUploadedResume(jobAd.Id, fileReference.Id, true, null));
            GetAppliedUrl(employer, jobAd);
            AssertStatus(jobAd, member.Id, true, true, fileReference.FileName);
        ...
        public void TestProfileLastUpdatedTime()
        {
            ...
            LogIn(member);
            AssertStatus(jobAd, member.Id, false, true, fileReference.FileName);
            AssertJsonSuccess(ApiApplyWithUploadedResume(jobAd.Id, fileReference.Id, false, null));
            GetAppliedUrl(employer, jobAd);
            AssertStatus(jobAd, member.Id, true, true, fileReference.FileName);
        ...
        public void TestMultipleFiles()
        {
            ...
            var applicationId = AssertApply(ApiApplyWithUploadedResume(jobAd.Id, fileReference2.Id, false, null));
            GetAppliedUrl(employer, jobAd);
        ...
        public void TestMultipleFilesUseForProfile()
        {
            ...
            LogIn(member);
            AssertStatus(jobAd, member.Id, false, true, fileReference2.FileName);
            var applicationId = AssertApply(ApiApplyWithUploadedResume(jobAd.Id, fileReference2.Id, true, null));
            GetAppliedUrl(employer, jobAd);
            AssertStatus(jobAd, member.Id, true, true, fileReference2.FileName);
        ...
        public void TestAlreadyApplied()
        {
            ...
            AssertJsonError(ApiApplyWithUploadedResume(jobAd.Id, fileReference.Id, false, null), null, "300", "This job has already been applied for.");
            AssertStatus(jobAd, member.Id, true, true, fileReference.FileName);
        }
    }
}