...
{
    [TestClass]
    public class LoggedInResumeTests
        : ManagedInternallyTests
    {
        ...
        public void TestSubmitProfileFileUseForProfile()
        {
            ...
            View(jobAd.Id, () => AssertView(true, false));
            var applicationId = AssertApply(Apply(employer, jobAd, fileReference.Id, true, CoverLetterText));
        ...
        public void TestProfileLastUpdatedTime()
        {
            ...
            View(jobAd.Id, () => AssertView(true, false));
            AssertApply(Apply(employer, jobAd, fileReference.Id, false, CoverLetterText));
        ...
        public void TestMultipleFiles()
        {
            ...
            View(jobAd.Id, () => AssertView(true, false));
            var applicationId = AssertApply(Apply(employer, jobAd, fileReference2.Id, false, CoverLetterText));
        ...
        public void TestMultipleFilesUseForProfile()
        {
            ...
            View(jobAd.Id, () => AssertView(true, false));
            var applicationId = AssertApply(Apply(employer, jobAd, fileReference2.Id, true, CoverLetterText));
        ...
        public void TestUnknownFile()
        {
            ...
            LogIn(member);
            AssertStatus(jobAd, member.Id, false, true, fileReference.FileName);
            AssertJsonError(ApiApplyWithUploadedResume(HttpStatusCode.NotFound, jobAd.Id, Guid.NewGuid(), false, CoverLetterText), null, "400", "The file cannot be found.");
            AssertStatus(jobAd, member.Id, false, true, fileReference.FileName);
        }
        ...
        public void TestAlreadyApplied()
        {
            ...
            View(jobAd.Id, () => AssertView(true, false));
            AssertJsonError(Apply(employer, jobAd, fileReference.Id, false, CoverLetterText), null, "300", "This job has already been applied for.");
